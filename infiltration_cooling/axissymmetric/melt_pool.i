...
[Mesh]
    [mesh0]
        ...
        file = 'gold/core_in_meltpool_noentities.msh'
    []
    [delete]
...
[Materials]
    [L]
        ...
        property_name = L
        expression = 'y-hv' #mesh geometry dependence
    ...
    [M]
        type = DerivativeParsedMaterial
        property_name = M
        expression = 'x:=if(L<0,if(L>-${L0},-L/${L0},1),0.00001); 3*x^2-2*x^3'
...
[Outputs]
    exodus = true
    file_base = '${base_folder}/melt_pool'
    console = false
