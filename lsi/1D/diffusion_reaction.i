...
h0 = '${fparse alpha0*oL/(r10^2)}'

aP0 = '${fparse h0/oP*(2*r10*d0^2+d0^4)}'
...
[NEML2]
    ...
    cli_args = 'phi0=${phi0} M=${M} lc=${lc} p=${p} oP=${oP} oL=${oL} rho_rat=${rho_rat} D_LP=${D_LP} sto_coef=${sto_coef} smooth=${smooth}'
    ...
    [all]
        ...
        moose_outputs = '     alpha_source       sqrtd       h        alphaP'
        neml2_outputs = '     state/alpha_source state/delta state/h  state/alphaP'

        moose_derivative_types = 'MATERIAL'
        moose_derivatives = 'neml2_jacobian'
        neml2_derivatives = 'state/alpha_source forces/alpha'

        initialize_outputs = '      sqrtd h    alphaP'
        initialize_output_values = 'd0    h0   aP0'
    []
[]
...
[Materials]
    [init_mat]
        ...
        prop_names = 'd0 h0 aP0 phi0'
        prop_values = '${d0} ${h0} ${aP0} ${phi0}'
    []
[]
...
[VectorPostprocessors]
    ...
    [line]
        ...
        end_point = '${xmax} 0 0'
        num_points = ${n}
        variable = 'alpha h sqrtd asource product_sat'
        sort_by = 'x'
    []
[]
