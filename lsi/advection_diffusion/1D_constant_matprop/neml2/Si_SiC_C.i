...
[Models]
    ...
    [capillary_pressure]
        ...
        effective_saturation = 'state/Seff'
        scaling_constant = '${van_genutchten_constant}'
        power = '${van_genutchten_power}'
        capillary_pressure = 'state/P'
        apply_log_extension = true
        transistion_saturation = '${transistion_saturation}'
    []
    [pore_pressure]
        type = ScalarLinearCombination
        from_var = 'state/P'
    ...
    [flux_advection]
        type = ScalarLinearCombination
        from_var = 'state/dPcdalpha'
        to_var = 'state/F_advec'
        coefficients = ${advec_constant}
    []
    [flux_total]
        type = ScalarLinearCombination
    ...
    [flux_out]
        type = ComposedModel
        models = 'dPcdalpha flux_advection flux_total'
    []
    [model]
        type = ComposedModel
