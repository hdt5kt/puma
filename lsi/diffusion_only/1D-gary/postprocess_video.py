...
## Input
basefolder = "results/"
plotfolder = "plot_results/sequence"
...
id = ["result"]
idlist = [["alpha", "phi_0", "phi_p"]]
idy = [["liquid substance (mol/V)", "porosity", "product volume fraction"]]
...
for keyid in range(len(id)):
    ...
    for i in range(1, 100000):
        ...
        filename = basefolder + "out_value_{:04d}.csv".format(i)
