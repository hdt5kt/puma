...
[Models]
    ...
    []
    ##########################################################################
    ############## temporary solution to non homogeneous parameter ###########
    [mb0_constant]
        type = ScalarVariableRate
        variable = 'state/mb0'
        time = 'forces/tt'
    ...
    [model_residual]
        type = ComposedModel
        models = 'rmp rms rmb rmg rVv mb0_constant ms0_constant V0_constant'
    ...
    [model_solver]
        ...
        additional_outputs = 'state/ms state/alpha state/ms0 state/mb0'
    []
    ################################### POST PROCESS #################################
    #########
    ######### weight fraction
    ...
    [model]
        ...
        additional_outputs = 'state/ms state/mp state/mg state/mb state/Vv state/V0'
    []
    #######################################################################################
[]