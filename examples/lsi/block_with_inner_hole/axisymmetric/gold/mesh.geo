...
nx_core1 = nx_pool;
nx_core2 = 5;
ny_core_down = 30; ny_core_down_progression = 1.1;
nx_core_side = 30; nx_core_side_progression = 1.1;
...
// Core Under
Line(101015) = {1, 1015};
Line(101505) = {1015, 5}; Transfinite Line{101505} = ny_core_down Using Progression ny_core_down_progression;
Line(50256) = {5, 256};
Line(256010) = {256, 10}; Transfinite Line{-256010} = ny_core_down Using Progression ny_core_down_progression;
Line(1002) = {10, 2};
Line(1001015) = {10, 1015};

// Core right
Line(25606) = {256, 6}; Transfinite Line{25606} = nx_core_side Using Progression nx_core_side_progression;
Line(601067) = {6, 1067}; Transfinite Line{-601067} = ny_core_down Using Progression ny_core_down_progression;
Line(10670267) = {1067, 267};
Line(2670967) = {267, 967};
Line(96707) = {967, 7};
Line(708) = {7, 8}; Transfinite Line{-708} = nx_core_side Using Progression nx_core_side_progression;
Line(1067010) = {1067, 10}; Transfinite Line{-1067010} = nx_core_side Using Progression nx_core_side_progression;
Line(26702) = {267, 2}; Transfinite Line{-26702} = nx_core_side Using Progression nx_core_side_progression;
Line(96709) = {967, 9}; Transfinite Line{-96709} = nx_core_side Using Progression nx_core_side_progression;
