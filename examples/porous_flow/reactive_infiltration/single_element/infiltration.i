...
[NEML2]
  ...
  cli_args = 'kk_L=${kk_ref} permeability_power=${permeability_power} rhof_nu=${fparse rho_Si/mu_Si}
              ...
              chem_ratio=${chem_ratio} mchem_P=${fparse -k_SiC} chem_scale=${fparse chem_scale/omega_Si} chem_p=${chem_p}
  ...
  [all]
    ...
    moose_outputs = '     M3             M4         M5         M6         delta_P
                          non_liquid     poro       perm       phip       phis'
    neml2_outputs = '     state/M3       state/M4   state/M5   state/M6   state/delta
